                      ...
                      <div className="flex items-center gap-4 mt-2 text-xs text-gray-500 flex-wrap">
                        ...
                        {task.date_fin_prevue && (
                          <span className="flex items-center gap-1">
                            ...
                            Échéance: {new Date(task.date_fin_prevue).toLocaleDateString()}
                          </span>
                        )}
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1 text-sm text-gray-600">
                          {task.titre_dossier && (
                            <>
                              <p><span className="font-medium">Dossier:</span> {task.dossier_titre}</p>
                              <p><span className="font-medium">Référence:</span> {task.dossier_reference}</p>
                            </>
                          )}
                          {task.date_debut && (
                          ...
                          {task.date_fin_prevue && (
                            <p><span className="font-medium">Date d&apos;échéance:</span> {new Date(task.date_fin_prevue).toLocaleDateString()}</p>
                          )}
                        </div>
                      </div>
                    </div>
